...
const About = () => {
  ...
  return (
    <div className='about  lg:my-20 ' id='about'>
      <div>
        <h2 className='text-center font-semibold text-3xl text-gray-600 ' data-aos="fade-up" data-aos-duration="600" data-aos-delay="100" >About Us</h2>
        <div>

          <section className="text-gray-600 body-font" data-aos="fade-up" >
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
              <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden flex justify-center items-center" data-aos="fade-right" >
                <img alt="feature" className="object-cover object-center h-auto" src={aboutImg} />
              </div>
              <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center" data-aos="fade-left" >
