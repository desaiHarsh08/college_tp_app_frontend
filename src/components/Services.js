    ...
    return (
        <div className='services' id='services'>
            ...
            <section className="text-gray-600 body-font">
                <div data-aos="fade-up" data-aos-duration="600" data-aos-delay="100"><h2 className='text-center font-semibold text-3xl' >Services</h2></div>
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                        <div className="p-4 md:w-1/3 flex" data-aos="fade-right" data-aos-duration="600" data-aos-delay="100">
                        ...
                        <div className="p-4 md:w-1/3 flex" data-aos="fade-up" data-aos-duration="600" data-aos-delay="100">
                            <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-blue-100 text-blue-500 mb-4 flex-shrink-0">
                                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
                        ...
                        <div className="p-4 md:w-1/3 flex" data-aos="fade-left" data-aos-duration="600" data-aos-delay="100">
                            <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-blue-100 text-blue-500 mb-4 flex-shrink-0">
                                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-6 h-6" viewBox="0 0 24 24">
